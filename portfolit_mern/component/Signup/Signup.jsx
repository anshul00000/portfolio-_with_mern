...
const registerUser = async () => {
  try {
    ...
    if (data.tooken) {
      ...
      setbutton(true);
      toast(data.message || data.msg || "Registration failed");
      console.log("register error:", data);
    }
  } catch (error) {
    setbutton(true);
    toast.error("Registration failed (network/server)");
    console.log("register server error:", error);
  }
};

// handler usable as form onSubmit
const login_save = async (e) => {
  ...
  return (
    <>
      ...
      <dialog ref={dialogRef} className='edit_profile_dialog'>
