...
function Follow({ my_id, back, un_follow }) {
  ...
  return (
    <>
      ...
      {
        // user ? <button className='follow_btn' value={my_id} onClick={follow}>{back ? "Follow back" : "Follow"} <i class="fa-solid fa-plus"></i> </button>
        //   :
          ...
          <button className='follow_btn' value={my_id} onClick={un_follow ? unfollow : follow}>
            {
              ...
              button ? "......" : (
                un_follow ? "Unfollow" : (back ? "Follow back " : "Follow ")
              )

            }

            {
              un_follow ? <i class="fa-solid fa-xmark"></i> :
