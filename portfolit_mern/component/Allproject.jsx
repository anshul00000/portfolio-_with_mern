...
<p><span className='project_title'> </span><br />{project.technologys}</p>
       ...
       <img src={`${backend_url}/public/images/${project.image}`} alt="Porject demo" onError={(e) => { e.target.src = 'default_project.jpg'; }}/>
...
<div className='project_user'>
    ...
    <img src={`${backend_url}/public/images/${project.owner.photo}`} alt="Porject demo" onError={(e) => { e.target.src = 'default.jpg'; }}/>
